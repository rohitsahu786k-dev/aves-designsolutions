  ...
  return (
    <div className="checkout-layout checkout-handoff">
      <section className="checkout-review">
        ...
        <p>Your bag will be transferred securely. Delivery address, shipping, coupon validation and payment are completed in the checkout portal.</p>
      ...
      <aside className="summary-panel premium-summary">
        ...
        <div className="summary-trust"><span><ShieldCheck size={16} /> Secure payment &amp; COD</span><span><PackageCheck size={16} /> Verified order receipt</span></div>
      </aside>
    </div>
  );
}
