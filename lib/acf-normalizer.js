...
export function normalizeSiteContact(post) {
  ...
  const supportEmail = acf.support_email ? String(acf.support_email).trim() : "aves.designsolutions@gmail.com";
  const salesEmail = acf.sales_email ? String(acf.sales_email).trim() : (acf.contact_email ? String(acf.contact_email).trim() : "aves.designsolutions@gmail.com");
